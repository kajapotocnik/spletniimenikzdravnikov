      ...
      <div class="diagnostics-right">
        ...
        <div class="service-item">
          <div class="service-icon">
            ...
            >
              <path
                d="M25.1,15c1.2-2.3,1.9-4.9,1.9-7.7c0-1.9-0.6-3.4-1.7-4.3c-2.1-1.7-5.5-0.9-7.7-0.4C17,2.7,16.3,2.9,16,2.9s-1-0.1-1.6-0.3C12.2,2.1,8.8,1.4,6.7,3C5.6,3.9,5,5.4,5,7.3c0,2.8,0.7,5.4,1.9,7.7c0.8,1.4,1,3.2,0.7,4.8c-1.5,7.6-0.4,9,0,9.5C7.9,29.8,8.4,30,9,30c2.1,0,3-2.4,3.9-4.7c0.8-2.1,1.7-4.4,3.1-4.4c1.7,0,2.9,2.8,3.8,5.1c0.9,2.2,1.7,4,3.2,4c0.6,0,1.1-0.2,1.4-0.7c0.4-0.5,1.5-1.8,0-9.5 C24.1,18.2,24.3,16.4,25.1,15z"
              />
            </svg>
          </div>
          Zobozdravstvo
