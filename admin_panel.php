  ...
  <body>
    <div class="admin-layout">
      <aside class="sidebar">
        ...
        <nav class="sb-nav">
          <a
            class="sb-link <?= $tab==='users'?'active':'' ?>"
            href="admin_panel.php?tab=users"
          >
            Uporabniki
          </a>
          <a
            class="sb-link <?= $tab==='doctors'?'active':'' ?>"
            href="admin_panel.php?tab=doctors"
          >
            Zdravniki
          </a>
          <a
            class="sb-link <?= $tab==='ratings'?'active':'' ?>"
            href="admin_panel.php?tab=ratings"
          >
            Ocene
          </a>
          ...
          <div class="card">
            <div class="card-head">
              <div>
                ...
                <div class="card-sub">
                  Brisanje / sprememba podatkov / povišanje v zdravnika.
                </div>
              </div>
            </div>
              ...
              <table class="table" id="dataTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <span
                        class="pill <?= $u['vloga']==='ADMIN'?'pill-dark':($u['vloga']==='ZDRAVNIK'?'pill-teal':'pill-soft') ?>"
                      >
                        <?= e($u['vloga']) ?>
                      </span>
                    </td>
                        ...
                        <div class="menu-drop">
                          ...
                          <form method="post" action="admin_actions.php">
                            <input
                              type="hidden"
                              name="action"
                              value="promote_to_doctor"
                            />
                            <input
                              type="hidden"
                              name="id_uporabnik"
                              value="<?= e($u['id_uporabnik']) ?>"
                            />
                          ...
                          <button
                            ...
                            onclick="closeAllMenus(); openUserEditFromBtn(this);"
                          >
                            Uredi
                          </button>
                          ...
                          <form
                            ...
                            onsubmit="return confirm('Res želiš izbrisati uporabnika? (izbriše tudi povezane podatke)')"
                          >
                            <input
                              type="hidden"
                              name="action"
            ...
            <div class="modal-card">
              <div class="modal-head">
                <div>
                  ...
                  <div class="modal-sub">
                    Spremeni osnovne podatke in vlogo.
                  </div>
                </div>
                <button
                  class="icon-btn"
              ...
              <form class="form-grid" action="admin_actions.php" method="post">
                ...
                <div class="fg">
                  <label>Ime</label><input name="ime" id="m_ime" required />
                </div>
                <div class="fg">
                  <label>Priimek</label
                  ><input name="priimek" id="m_priimek" required />
                </div>
                <div class="fg">
                  <label>Email</label
                  ><input name="email" id="m_email" type="email" required />
                </div>
                <div class="fg">
                  <label>Vloga</label>
                      ...
                      <details class="menu" data-menu>
                        ...
                        <div class="menu-drop">
                          <button
                            ...
                            onclick="closeAllMenus(); openDoctorEditFromBtn(this);"
                          >
                            Uredi
                          </button>
                          ...
                          <form
                            method="post"
                            action="admin_actions.php"
                            onsubmit="return confirm('Izbrišem zdravnika (tudi ocene in povezave specializacij)?')"
                          >
                            <input
                              type="hidden"
                              name="action"
                            ...
                            <input
                              type="hidden"
                              name="id_zdravnik"
                              value="<?= e($d['id_zdravnik']) ?>"
                            />
                            <input
                              type="hidden"
                              name="id_uporabnik"
                              value="<?= e($d['TK_uporabnik']) ?>"
                            />
                            <button class="menu-item danger" type="submit">
                              Izbriši
                            </button>
            ...
            <div class="modal-card">
              <div class="modal-head">
                <div>
                  ...
                  <div class="modal-sub">
                    Uredi osnovne podatke uporabnika in dodatne podatke iz
                    tabele zdravnik.
                  </div>
                </div>
                <button
              ...
              <form class="form-grid" action="admin_actions.php" method="post">
                ...
                <div class="fg">
                  <label>Ime</label><input name="ime" id="dm_ime" required />
                </div>
                <div class="fg">
                  <label>Priimek</label
                  ><input name="priimek" id="dm_priimek" required />
                </div>
                <div class="fg">
                  <label>Email</label
                  ><input name="email" id="dm_email" type="email" required />
                </div>

                <div class="fg">
                  <label>Naziv</label><input name="naziv" id="dm_naziv" />
                </div>
                <div class="fg">
                  <label>Telefon</label><input name="telefon" id="dm_telefon" />
                </div>
                <div class="fg">
                  <label>Klinika</label><input name="klinika" id="dm_klinika" />
                </div>
                <div class="fg">
                  <label>Mesto</label><input name="mesto" id="dm_mesto" />
                </div>
              ...
              <table class="table" id="dataTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <?= e($r['d_ime'].' '.$r['d_priimek']) ?>
                      <span class="muted"
                        >(ID
                        <?= e($r['id_zdravnik']) ?>)</span
                      >
                    </td>
                    <td>
                    ...
                    <td class="ta-right">
                      <form
                        method="post"
                        action="admin_actions.php"
                        onsubmit="return confirm('Izbrišem to oceno?')"
                      >
                        <input
                          type="hidden"
                          name="action"
    ...
    <script>
      ...
      function openUserEdit(id, ime, priimek, email, vloga) {
        ...
        document.getElementById("m_vloga").value =
          vloga === "ZDRAVNIK" ? "ZDRAVNIK" : "UPORABNIK";
      ...
      // ⋮ + click + ESC
      const menus = () =>
        Array.from(document.querySelectorAll("details[data-menu]"));
